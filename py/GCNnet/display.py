...
from dataset import DatasetGCNSegTeethPrediction, DatasetGCN
...
def main(args):
    ...
    # ds = DatasetGCNSegTeeth(args.input,landmark=args.landmark,transfrom=None)
    ds = DatasetGCN(path = args.csv_train, landmark=args.landmark, transfrom=FaceToEdge(remove_faces=False))
    ...
    print(f'post landmark {pos_landmark}')
