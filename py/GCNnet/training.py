...
def main(args):
    ...
    if args.load_checkpoint :
        ...
        model = GCNNet(lr = args.lr, batch_size=args.batch_size)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--out', help='Output', type=str, default="/home/luciacev/Desktop/Data/ALI_IOS/landmark/Training/GCN/model")
